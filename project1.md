...
![Enable inbound web traffic](./media/apachdef.png)
...
![Enable inbound web traffic](./media/mysqlint.png)
...
![Enable inbound web traffic](./media/mysqllogin.png)
...
![Enable inbound web traffic](./media/mysqlpsw.png)
...
![Enable inbound web traffic](./media/phpv.png)
...
![Enable inbound web traffic](./media/virtup.png)
...
![Enable inbound web traffic](./media/a2en.png)
...
![Enable inbound web traffic](./media/a2dis.png)
...
![Enable inbound web traffic](./media/phpdef.png)
